...
{
    public class Andalucia70sDuelOpponentBuilder : MonoBehaviour
    {
        public void Build()
        {
            CreateOpponents();

            Debug.Log("[Module Z] Rivales Duel Andalucía años 70 creados.");
        }

        private void CreateOpponents()
        {
            CreateOpponent(
                "Andalucia_Rival_Principal",
            ...
            CreateOpponent(
                "Andalucia_Rival_Secundario_C",
                new Vector3(0f, 0f, 7f),
                new Color(0.20f, 0.55f, 0.22f),
                new Color(0.08f, 0.08f, 0.08f)
            );
        }
            ...
            Color pantsColor)
        {
            ...
            CreatePart("Pelo_Andalucia", root.transform, new Vector3(0f, 1.92f, 0f), new Vector3(0.5f, 0.18f, 0.5f), new Color(0.08f, 0.05f, 0.03f));
