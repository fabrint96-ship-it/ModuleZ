...
{
    public class Madrid70sDuelOpponentBuilder : MonoBehaviour
    {
        public void Build()
        {
            CreateOpponents();

            Debug.Log("[Module Z] Rivales Duel Madrid años 70 creados.");
        }

        private void CreateOpponents()
        {
            CreateOpponent(
                "Duel_Rival_Principal",
