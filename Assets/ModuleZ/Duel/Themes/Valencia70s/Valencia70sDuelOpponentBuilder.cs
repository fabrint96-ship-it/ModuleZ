...
{
    public class Valencia70sDuelOpponentBuilder : MonoBehaviour
    {
        public void Build()
        {
            CreateOpponents();

            Debug.Log("[Module Z] Rivales Duel Valencia años 70 creados.");
        }

        private void CreateOpponents()
        {
            CreateOpponent(
                "Valencia_Rival_Principal",
            ...
            CreateOpponent(
                "Valencia_Rival_Secundario_A",
                new Vector3(-4f, 0f, 9f),
                new Color(0.90f, 0.38f, 0.14f),
                new Color(0.10f, 0.08f, 0.06f)
            );

            CreateOpponent(
                "Valencia_Rival_Secundario_B",
                new Vector3(4f, 0f, 9f),
